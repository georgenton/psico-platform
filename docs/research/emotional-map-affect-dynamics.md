...
| **2** | OU v0 (aproximación ordinal-numérica)           | ✅ **En vivo** — drive el eje Calma vía volatilidad medida; kill-switch `EMOTIONAL_MAP_OU=off`; degrada a Tier 1 si faltan datos | metadata server-side                           |
